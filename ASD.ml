...
and variable = Var of ident | Tab of ident * expression

and decl_variable = DVar of ident | DTab of ident * int

and params = Var_params of ident | Tab_params of ident
...
and typ = Type_Int | Type_Tid | Type_Tab of int | Type_Tab_Ptr
