...
and ir_of_instruction l = match l with 
  |[] -> Empty
  |[a] -> Atom (instr_of_instruction a)
  |a::q -> Concat (Atom(instr_of_instruction a) , ir_of_instruction q)

and instr_of_instruction  (instr : instruction) : llvm_instr = match instr with 
